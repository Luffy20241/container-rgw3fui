...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-rgw3fui.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-rgw3fui.containers.anotherwebservice.com/
...
```
git clone git@github.com:Luffy20241/container-rgw3fui.git
cd container-rgw3fui
```
...
```
docker attach container-rgw3fui
```
